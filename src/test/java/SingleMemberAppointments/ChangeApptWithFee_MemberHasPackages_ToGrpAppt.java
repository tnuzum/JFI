...
public class ChangeApptWithFee_MemberHasPackages_ToGrpAppt extends base {
	...
	public ChangeApptWithFee_MemberHasPackages_ToGrpAppt() {
...
//	@BeforeTest
	...
	public void ChangeAppointmentWithFee() throws IOException, InterruptedException {
		try {
			rm.activeMemberLogin("apptmember7", "Testing1!");
			...
			startTime1 = rm.BookApptWith2Resources(clubName, productCategory1, appointmentToBook1, resourceName1,
					resourceName2);
