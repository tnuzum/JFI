...
public class NoAgreement_AddCreditCard_FreezeMbr extends base {
	...
	public NoAgreement_AddCreditCard_FreezeMbr() {
...
//		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
	...
	public void deleteCardInCOG() throws InterruptedException, IOException {
		try {
			...
			rm.deleteFOPInCOG("1147812", "Jonas Sports-Plex", "1111", "No", "");
