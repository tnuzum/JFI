...
public class NoAgreement_AddCanadianBankSavingsAcct_FreezeMbr extends base {
	...
	public NoAgreement_AddCanadianBankSavingsAcct_FreezeMbr() {
...
//		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
	...
	public void deleteCardInCOG() throws InterruptedException, IOException {
		try {
			...
			rm.deleteFOPInCOG("1147812", "Jonas Sports-Plex", prop.getProperty("CanadianBankLast4Digits"), "No", "");
