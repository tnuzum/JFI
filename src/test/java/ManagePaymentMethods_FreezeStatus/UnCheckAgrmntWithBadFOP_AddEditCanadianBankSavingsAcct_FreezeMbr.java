...
public class UnCheckAgrmntWithBadFOP_AddEditCanadianBankSavingsAcct_FreezeMbr extends base {
	...
	public UnCheckAgrmntWithBadFOP_AddEditCanadianBankSavingsAcct_FreezeMbr() {
...
//		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
	...
	public void EditCanadianBankSavingsAcct_SelectAgreement() throws InterruptedException, IOException {
		...
		try {
			...
			Assert.assertTrue(mp.getEditSavingsRadio1().isSelected());
	...
	public void deleteCardInCOG() throws InterruptedException, IOException {
		try {
			...
			rm.deleteFOPInCOG("1147808", "Jonas Health and Wellness", prop.getProperty("CanadianBankLast4Digits"),
					"Yes", agreement);
