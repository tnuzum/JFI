...
public class ChangeByHoh_PerAppointment_Group_WithFees_PkgReqd extends base {

	private static String clubName1 = "Jonas Fitness";
	private static String clubName2 = "Studio Jonas";
	private static String productCategory = "Personal Training 1";
	private static String appointmentToBook = "PerAptChangeFee-Grp";
	...
	public ChangeByHoh_PerAppointment_Group_WithFees_PkgReqd() {
	...
	public void ChangeAppointmentForFamilyMember() throws InterruptedException, IOException {
		...
		try {
			...
			startTime1 = rm.BookGrpApptWith2Resources(clubName1, productCategory, appointmentToBook, resourceName1,
