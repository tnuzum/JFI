...
public class ChangeByHoh_PerMember_Single_WithFees_NoPkg extends base {

	private static String clubName = "Jonas Fitness";
	private static String productCategory = "Personal Training";
	private static String appointmentToBook = "PerMemberChngeFeeCncelFee";
	...
	public ChangeByHoh_PerMember_Single_WithFees_NoPkg() {
	...
	public void ChangeAppointmentForFamilyMember() throws InterruptedException, IOException {
		...
		try {
			...
			startTime1 = rm.BookApptWith2Resources(clubName, productCategory, appointmentToBook, resourceName1,
					resourceName2);
