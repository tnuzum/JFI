...
public class UnenrollStandbyClass extends base {
	private static Logger log = LogManager.getLogger(base.class.getName());
	private static String ClassToEnroll = "UNENRLLSTNDBYCLASS";
	private static String ClassNameDisplayed = "UnenrllStndByClass";
