...
public class ChangeGrpApptWithFee_ClubReqPackages_AdditionalResources extends base {
	...
	public ChangeGrpApptWithFee_ClubReqPackages_AdditionalResources() {
...
//	@BeforeTest
	...
	public void ChangeAppointmentWithFee() throws IOException, InterruptedException {
		try {
			rm.activeMemberLogin("apptmember12", "Testing1!");
...
//					}
			...
			Assert.assertTrue(ap.getNewAppointmentBanner().getText().contains(participant3));
...
//Navigate to Dashboard
	...
	public void ConfirmNewAppointmentIsScheduled() throws IOException, InterruptedException {
		try {
			...
			rm.ApptCheckinInCOG("Auto, apptmember12", appointmentToBook2, "apptmember12", "1"); // Check In the
			// Member
			// to the
			// appointment
