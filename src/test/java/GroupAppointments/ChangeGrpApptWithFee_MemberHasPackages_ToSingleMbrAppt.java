...
public class ChangeGrpApptWithFee_MemberHasPackages_ToSingleMbrAppt extends base {
...
//	@BeforeTest
	...
	public void ChangeAppointmentWithFee() throws IOException, InterruptedException {
		reusableMethods.activeMemberLogin("apptmember9", "Testing1!");
		
		//Book an appointment and get the start time for the appointment
		startTime1 = reusableMethods.BookGrpApptWith2Resources(clubName, productCategory1, appointmentToBook1, resourceName1, resourceName2);
