...
public class ClubReqPackages_GrpAppt_MultiResourcesNotSelectedOnAccount extends base {
	private static Logger log = LogManager.getLogger(base.class.getName());
	private static String clubName;
	private static String productCategory;
	private static String appointmentToBook;
	private static String resourceName;
	private static String additionalResourceName;
	private static String clubNameDisplayed;
	private static String mssClubPricing;
	private static String startTime;
	private static int appointmentsCount;
	private static String participant2;
	private static String unitsToBeSelected;
	private static JavascriptExecutor jse;

	public reusableWaits rw;
	public reusableMethods rm;

	public ClubReqPackages_GrpAppt_MultiResourcesNotSelectedOnAccount() {
...
//	@BeforeTest
	...
	public void initialize() throws IOException, InterruptedException {
		...
		clubName = prop.getProperty("clubName");
		productCategory = prop.getProperty("productCategory");
		appointmentToBook = prop.getProperty("appointmentToBook");
		resourceName = prop.getProperty("resourceName");
		additionalResourceName = prop.getProperty("additionalResourceName");
		clubNameDisplayed = prop.getProperty("clubNameDisplayed");
		mssClubPricing = prop.getProperty("mssClubPricing");

		participant2 = prop.getProperty("participant2");
		unitsToBeSelected = prop.getProperty("unitsToBeSelected");
...
//Verifies the package units is now incremented by one unit
		...
		rm.myProfileLogin("ApptMember1", "Testing1!");
