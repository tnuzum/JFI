...
public class ChangeGrpApptWithOutFee_ClubReqPackages extends base {
	...
	public ChangeGrpApptWithOutFee_ClubReqPackages() {
...
//Navigate to Dashboard
	...
	public void ConfirmNewAppointmentIsScheduled() throws IOException, InterruptedException {
		try {
			...
			rm.ApptCheckinInCOG("Auto, apptmember8", appointmentToBook2, "apptmember8", "1"); // Check In the Member
																								// to the
																								// appointment
