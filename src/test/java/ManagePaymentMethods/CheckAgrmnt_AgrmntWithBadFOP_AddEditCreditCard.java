...
public class CheckAgrmnt_AgrmntWithBadFOP_AddEditCreditCard extends base {
	...
	public CheckAgrmnt_AgrmntWithBadFOP_AddEditCreditCard() {
...
//		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
	...
	public void AddNewCard_SelectAgreementWithBadFOP() throws InterruptedException, IOException {
		...
		try {
			...
			Thread.sleep(1000);
			jse.executeScript("arguments[0].scrollIntoView();", mp.getSignaturePad().get(1));
			Thread.sleep(1000);
