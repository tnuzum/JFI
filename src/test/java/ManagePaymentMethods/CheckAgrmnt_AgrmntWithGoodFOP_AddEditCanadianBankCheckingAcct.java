...
public class CheckAgrmnt_AgrmntWithGoodFOP_AddEditCanadianBankCheckingAcct extends base {
	...
	public CheckAgrmnt_AgrmntWithGoodFOP_AddEditCanadianBankCheckingAcct() {
...
//		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
	...
	public void EditCanadianBankCheckingAcct() throws InterruptedException, IOException {
		...
		try {
			...
			Assert.assertTrue(mp.getPopupContent().getText().contains("A signature is required to continue."));
			Thread.sleep(1000);
			jse.executeScript("arguments[0].click();", mp.getPopupConfirmationButton());
			Thread.sleep(1000);
