...
public class Bug167782AgreementSectionNoThanksDisplayedEvenIfThereIsNoAgreementToDisplay extends base {
	...
	public Bug167782AgreementSectionNoThanksDisplayedEvenIfThereIsNoAgreementToDisplay() {
...
//		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
	...
	public void AddUSBankCheckingAcct() throws InterruptedException, IOException {
		...
		try {
			rm.activeMemberLogin("bugmbr", "Testing1!");
	...
	public void deleteCardInCOG() throws InterruptedException, IOException {
		try {
			...
			rm.deleteFOPInCOG("1143720", "Jonas Sports-Plex", prop.getProperty("USBankLast4Digits"), "No", "");
