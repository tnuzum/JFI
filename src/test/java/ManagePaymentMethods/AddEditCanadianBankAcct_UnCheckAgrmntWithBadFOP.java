...
public class AddEditCanadianBankAcct_UnCheckAgrmntWithBadFOP extends base {
	...
	public AddEditCanadianBankAcct_UnCheckAgrmntWithBadFOP() {
...
//		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
	...
	@Test(priority = 1, description = "Adding a Canadian Bank Account but not linking the card to agreement with Bad FOP")
	public void AddCanadianBankAcct_SelectAreYouSure() throws InterruptedException, IOException {
	...
	@Test(priority = 2, description = "Editing a Canadian Bank Account and linking the card to agreement with Bad FOP")
	public void EditCanadianBankAcct_SelectAgreement() throws InterruptedException, IOException {
	...
	public void deleteCardInCOG() throws InterruptedException, IOException {
		try {
			...
			rm.deleteFOPInCOG("1143412", "Jonas Sports-Plex", prop.getProperty("CanadianBankLast4Digits"), "No");
