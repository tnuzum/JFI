...
public class DashBoard_Layout_Browser extends base2 {

	public reusableMethods rm;

	public DashBoard_Layout_Browser() {
...
//	@BeforeTest
	@BeforeClass
	@Parameters({ "Browser" })
	public void initialize(String Browser) throws InterruptedException, IOException {
